...
export default function UserOverview() {
    ...
    const [selectedOption, setSelectedOption] = useState<DropDownListData | null>(null);
            ...
            <div className="grid grid-cols-3 gap-6">
                <div className="bg-white rounded-2xl shadow-md p-4 h-[320px]">
                    ...
                    <div className="flex items-start h-full">
                        <div className="text-2xl font-bold">{searchResult && searchResult?.kn}</div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-md p-4 h-[320px]">
                    ...
                    <div className="flex items-start h-full">
                        <div className="text-2xl font-bold">{searchResult && searchResult?.en}</div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl shadow-md p-4 h-[320px]">
                    ...
                    <div className="flex items-start h-full">
                        <div className="text-2xl font-bold">{searchResult && searchResult?.gics}</div>
                    </div>
                </div>
            </div>
            <div className="grid grid-cols-3 gap-6">
